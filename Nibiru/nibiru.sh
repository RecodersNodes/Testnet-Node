...
echo -e "Nama Chain: \e[1m\e[32m$NIBIRU_CHAIN_ID\e[0m"
echo -e "Port: \e[1m\e[32m$NIBIRU_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "Untuk check sync status: \e[1m\e[32mcurl -s localhost:${NIBIRU_PORT}657/status | jq .result.sync_info\e[0m"