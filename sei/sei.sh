...
echo -e "\e[1m\e[32m2. Sedang Menginstal... \e[0m" && sleep 1
# packages
...
echo -e "\e[1m\e[32m3. Downloading ... \e[0m" && sleep 1
# download binary
cd $HOME
...
echo -e "\e[1m\e[32m4. Mulai service... \e[0m" && sleep 1
# create service
...
echo '=============== SETUP SELESAI ==================='
echo -e 'Buat Cek logs: \e[1m\e[32mjournalctl -u seid -f -o cat\e[0m'
echo -e "Buat Cek sync status: \e[1m\e[32mcurl -s localhost:${SEI_PORT}657/status | jq .result.sync_info\e[0m"