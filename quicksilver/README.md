...
<div class="snippet-clipboard-content notranslate position-relative overflow-auto"><pre class="notranslate"><code>wget -O quicksilver.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/quicksilver/quicksilver.sh &amp;&amp; chmod +x quicksilver.sh &amp;&amp; ./quicksilver.sh
...
<pre class="notranslate"><code>QUICKSILVER_WALLET_ADDRESS=$(quicksilverd keys show $WALLET -a)
